...
urlpatterns = [
    ...
    path('detailed_post/comment/<int:id>', views.write_comment, name='write-comment'),
    path('detailed_post/comment/delete/<int:id>', views.delete_comment, name='delete-comment'),    
]